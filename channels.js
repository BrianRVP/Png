// Channels Module for BFlix®TV | M7 / Movian Media Center
// Version: 1.0
// Author: F0R3V3R50F7
exports.addChannels = function (page) {
    ...
    if (service.selectRegion == "United States") {
        ...
        page.appendItem('m3uGroup:https://raw.githubusercontent.com/BrianRVP/lista.m3u/main/Series:USA:Pluto TV', 'video', { icon: 'https://images.pluto.tv/channels/5e793a7cfbdf780007f7eb75/colorLogoPNG.png', });
        ...
        page.appendItem('m3u:https://raw.githubusercontent.com/BrianRVP/lista.m3u/main/Series:Redbox', 'video', { icon: 'https://mma.prnewswire.com/media/858885/redbox_logo.jpg?p=facebook', });
